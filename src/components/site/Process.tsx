...
const steps: Array<{
  ...
  },
  {
    ...
    description: [
      "После определения риск-профиля формируется аналитический фокус: какие сектора, инструменты и типы стратегий на рынке США соответствуют интересам клиента и требуют внимания. Также клиентом определяются критерии отбора этих инструментов. Критерии синхронзируются с реальными рыночными условиями.",
      "Мы анализируем широкий рынок, и выделяем те идеи, которые клиент рассматривает подходящими к горизонту, капиталу, допустимому риску и уровню понимания инструментов.",
    ],
    goal: "Сузить фокус до тех направлений, которые действительно соответствуют задачам клиента, и исключить лишний рыночный шум.",
    benefit: [
