...
export function Hero() {
  return (
    <section
      id="top"
      className="section-shell scroll-mt-28 relative min-h-screen flex items-end lg:items-center pt-28 pb-8 md:pb-10 px-5 lg:px-10 bg-background"
    >
      ...
      <div className="relative z-10 mx-auto max-w-7xl w-full">
        <div className="max-w-4xl reveal">
          ...
          <h1 className="max-w-4xl text-[2.45rem] sm:text-[3.75rem] lg:text-[5.8rem] leading-[0.96] text-foreground">
            Частная аналитика для <span className="text-gold italic">взвешенных решений</span> на
            рынке США
          </h1>

          <div className="mt-8 grid gap-4 max-w-3xl text-base md:text-lg text-muted-foreground leading-relaxed">
            <p>
        ...
        <div className="mt-14 md:mt-20 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 border border-border/45 bg-border/35 gap-px reveal reveal-delay-2">
          {theses.map((item) => (
            <article
              key={item.title}
