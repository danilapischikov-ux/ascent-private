...
export function Section({
  ...
  return (
    <section
      id={id}
      className={`section-shell scroll-mt-28 bg-background py-5 md:py-7 lg:py-8 px-5 lg:px-10 ${className}`}
    >
      {image && (
      ...
      <div className="relative z-10 mx-auto max-w-7xl">
        <div className="max-w-3xl mb-12 md:mb-16 reveal">
          ...
          <h2 className="text-4xl md:text-5xl lg:text-6xl leading-[1.02] text-foreground">
            {title}
          </h2>
          {subtitle && (
